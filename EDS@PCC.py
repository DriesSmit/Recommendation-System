...
#Notes: This allows for harser ratings
# It looks like the system only considers commonly ranked items without a penality for the amount of commonly ranked items?
#This means a person with only two movies rated can significantly influence another persons recommendations.
#The systems also scores perfect correlation if there is two or less commonly score items.
